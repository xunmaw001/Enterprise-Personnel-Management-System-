    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="考勤唯一编号" prop="hetongUuidNumber">
                       <el-input v-model="ruleForm.hetongUuidNumber"
                                 placeholder="考勤唯一编号" clearable  :readonly="ro.hetongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="考勤唯一编号" prop="hetongUuidNumber">
                           <el-input v-model="ruleForm.hetongUuidNumber"
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="日期" prop="kaoqinTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kaoqinTime" label="日期" prop="kaoqinTime">

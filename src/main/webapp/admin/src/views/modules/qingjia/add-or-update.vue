    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="请假唯一编号" prop="qingjiaUuidNumber">
                       <el-input v-model="ruleForm.qingjiaUuidNumber"
                                 placeholder="请假唯一编号" clearable  :readonly="ro.qingjiaUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="请假唯一编号" prop="qingjiaUuidNumber">
                           <el-input v-model="ruleForm.qingjiaUuidNumber"
                                     placeholder="请假唯一编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   qingjiaUuidNumber: [
                              { required: true, message: '请假唯一编号不能为空', trigger: 'blur' },
                          ],
                   yuangongId: [

                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yuangongEntity.setYuangongName(data.get(1));                    //员工姓名 要改的
                            yuangongEntity.setYuangongPhone(data.get(2));                    //员工手机号 要改的
                            yuangongEntity.setYuangongIdNumber(data.get(3));                    //员工身份证号 要改的
                            yuangongEntity.setYuangongPhoto("");//照片
                            yuangongEntity.setSexTypes(Integer.valueOf(data.get(4)));   //性别 要改的
                            yuangongEntity.setBumenTypes(Integer.valueOf(data.get(5)));   //部门 要改的
                            yuangongEntity.setZhiweiTypes(Integer.valueOf(data.get(6)));   //职位 要改的
                            yuangongEntity.setYuangongEmail(data.get(7));                    //电子邮箱 要改的
                            yuangongEntity.setRuzhiTime(sdf.parse(data.get(8)));          //入职日期 要改的
